    ...
    <>
      ...
      <div className="landing-light min-h-screen bg-slate-950 text-slate-50">
        <header className="sticky top-0 z-20 border-b border-slate-800 bg-slate-950/95 backdrop-blur">
          ...
          >
            ...
            <div className="hidden items-center gap-2 text-sm font-semibold text-slate-300 lg:flex">
              ...
              <a className="rounded-md px-3 py-2 hover:bg-slate-900 hover:text-white" href="#mercados">
                Mercados
              </a>
        ...
        <main>
          ...
          >
            <div>
              ...
              <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-200">
                Trabajamos con empresas de toda España. Nuestros mercados locales prioritarios actuales son Madrid, Barcelona, Valencia, Sevilla, Alicante y Málaga.
              </p>
          ...
          >
            <div>
              <p className="mb-3 text-sm font-black uppercase tracking-normal text-blue-400">Mercados</p>
              <h2 id="markets-title" className="text-3xl font-black text-slate-900 sm:text-4xl">
                España como área de servicio, con foco local donde hay páginas propias
              </h2>
            </div>
            <div className="grid gap-4 text-lg leading-8 text-slate-300">
              <p>
                No usamos datos estructurados para aparentar sedes físicas ni oficinas locales. Cuando hablamos de
                Madrid, Barcelona, Valencia, Sevilla, Alicante o Málaga lo hacemos como mercados prioritarios de
                captación, no como direcciones postales.
              </p>
              <p>
                Esta página resume quién está detrás del sitio y cómo se ordenan los servicios. Para una propuesta
                concreta, el punto de entrada sigue siendo la auditoría gratuita.
              </p>
            </div>
          </section>
